...
beautiful.init( home_path .. "/.config/awesome/zenburn/theme.lua")
...
--    tags[s] = awful.tag({ "一", "二" , "三","四", "五", "六", "七", "八", "九" }, s, layouts[1])
    tags[s] = awful.tag({ "١‎", "٢‎" , "‎٣","٤", "٥", "‎٦", "‎٧‎", "٨‎", "٩" }, s, layouts[1])
end
-- }}}
...
local mem_graph = blingbling.line_graph({height = 30,
                                        width = 60,
                                        show_text = true,
                                        label = "MEM: $percent %",
                                        rounded_size = 0.3,
...
awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer -D pulse sset Master 9%+", false) end),
awful.key({ }, "XF86AudioLowerVolume", function () awful.util.spawn("amixer -D pulse sset Master 9%-", false) end),
awful.key({ }, "XF86AudioMute", function () awful.util.spawn("amixer -D pulse set Master 1+ toggle", false) end),
  ...
  awful.key({modkey }, "Print", function ()
    awful.util.spawn("scrot '%Y-%m-%d."..random_string(5)..".png' --exec 'eog \"$f\"; mv \"$f\" " .. home_path .. "/Pictures'")
  end),
  awful.key({modkey, "Shift" }, "Print", false, function ()
    awful.util.spawn("scrot '%Y-%m-%d."..random_string(5)..".png' --select --exec 'eog \"$f\"; mv \"$f\" " .. home_path .. "/Pictures'")
  end),
