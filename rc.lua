...
-- BAT
local BAT0 = battery_widget { adapter = "BAT0", ac = "AC", tooltip_text = '${time_est} ' }

-- CPU Usage
cpu = wibox.widget.textbox()
vicious.register(cpu, vicious.widgets.cpu, 'CPU: $1% ',	1)

-- MEM Usage
mem = wibox.widget.textbox()
vicious.register(mem, vicious.widgets.mem, 'MEM: $1% ',	1)
...
beautiful.wallpaper = awful.util.get_configuration_dir() .. "ubuntu-dark.jpg"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "١‎", "٢‎" , "‎٣","٤", "٥", "‎٦", "‎٧‎", "٨‎", "٩" }, s, awful.layout.layouts[1])
...
--awful.key({ }, "XF86AudioMute", function () awful.util.spawn("amixer -D pulse set Master 1+ toggle", false) end),
  ...
  awful.key({"Shift" }, "Print", false, function ()
